...
export function StickyCTA() {
  ...
  return (
    <div className="fixed bottom-0 inset-x-0 z-40 md:bottom-4 md:right-4 md:left-auto md:inset-x-auto md:max-w-md pointer-events-none">
      <div className="pointer-events-auto glass-elevated md:rounded-2xl px-4 py-3 md:px-5 md:py-4 flex items-center gap-3">
        ...
        <Link
          href="/contact"
          data-float=""
          className="inline-flex items-center gap-1 btn-glass-primary px-3 py-2 rounded-full text-xs sm:text-sm font-medium transition-colors whitespace-nowrap"
        >
